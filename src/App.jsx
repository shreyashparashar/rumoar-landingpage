...
import { useFrame, reduced, Grain, Reticle, Timecode, scrollTo } from "./lib.jsx";
import { Boot, Stage } from "./board.jsx";
import { Creed, Statement, Next, Film, Collection, Opinion, Close } from "./sections.jsx";
  ...
  return (
    <nav className={`nav ${stuck ? "stuck" : ""} ${hide ? "hide" : ""}`}
      ...
      <div className="navin">
        ...
        <button className="navlink opt" onClick={() => scrollTo("pieces")}>The collection</button>
        <Timecode />
